...
router.post('/inquire-by-nick/tr', authorize, async (req, res) => {
    try {
      ...
      res.redirect('/inquire-by-nick/tr')
    } catch (e) {
      res.redirect('/inquire-by-nick/tr')
      console.log(e)
    }
...
router.post('/inquire-by-nick/en', authorize, async (req, res) => {
  try {
    ...
    res.redirect('/inquire-by-nick/en')
  } catch (e) {
    res.redirect('/inquire-by-nick/en')
    console.log(e)
  }
